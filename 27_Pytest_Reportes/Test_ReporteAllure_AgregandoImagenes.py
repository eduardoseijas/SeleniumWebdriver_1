...
from AA_Libreria_Funciones_Globales.Page_loguinglobal import Page_Loguinglobal
from allure_commons.types import AttachmentType #libreria para agregar imagenes en allure
...
def test_uno():
    ...
    allure.attach(driver.get_screenshot_as_png(), name="Agregandoalcarritodecompra", attachment_type=AttachmentType.PNG)
    f.Click_Mixto("xpath","//button[@id='back-to-products']",1)
    allure.attach(driver.get_screenshot_as_png(),name="Regresanalapaganterior",attachment_type=AttachmentType.PNG)
    #este comando es para colocar imagenes en allure
