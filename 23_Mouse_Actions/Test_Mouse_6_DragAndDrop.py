...
class PruebaLogin(unittest.TestCase):
    ...
    def test_login1(self,):
        ...
        f.Mouse_DragAndDrop("xpath","//div[@id='draggable1']//p[contains(text(),'Drag me')]","//div[@id='droppable1']",2)
        f.Mouse_DragAndDrop("xpath","//div[@id='draggable2']//p[contains(text(),'Drag me')]","//div[@id='droppable2']",3)
        f.Mouse_DragAndDrop("xpath","//div[@id='draggable1']//p[contains(text(),'Drag me')]","//div[@id='droppable2']",3)
        f.Mouse_DragAndDrop("xpath", "//div[@id='draggable2']//p[contains(text(),'Drag me')]","//div[@id='droppable1']", 3)
